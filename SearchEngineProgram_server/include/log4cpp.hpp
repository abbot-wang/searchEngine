...
public:
    static Mylogger &getInstance(const string &filename = "../log/SearchEngine.log", const string &fileAppenderName = "logfile", ostream &os = cout, const string &osAppenderName = "teminal")
    {
